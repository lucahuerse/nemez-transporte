...
interface EntruempelungRequestFormProps {
  onSuccess?: () => void
  onBack?: () => void
  embedded?: boolean
}

export function EntruempelungRequestForm({ onSuccess, onBack, embedded = false }: EntruempelungRequestFormProps) {
    ...
    <>
      {!embedded && (
        <div className="text-left mb-12">
          <h2 className="text-4xl sm:text-5xl font-semibold mb-3 tracking-tight text-center">Anfrage zur Entrümpelung</h2>
          <p className="text-muted-foreground text-lg text-center">
            Teilen Sie uns die Details zum Objekt mit und wir vereinbaren einen Besichtigungstermin.
          </p>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2 relative">
            <Label htmlFor="date" className="text-base font-medium">
              Wunschdatum der Besichtigung <span className="text-red-500">*</span>
            </Label>
            <Controller
              name="requestedDate"
              control={control}
        ...
        <div className="space-y-4 pt-4">
          <div className="flex items-center gap-2 mb-2">
            <Label className="text-base font-medium">Adresse des Objekts <span className="text-red-500">*</span></Label>
          </div>
        ...
        <div className="space-y-2 relative pt-2">
          <Label htmlFor="message" className="text-base font-medium">
            Details zur Entrümpelung <span className="text-red-500">*</span>
          </Label>
          <CustomTextarea 
            id="message" 
            placeholder="Was genau soll entrümpelt werden? (Dachboden, Keller, ganze Wohnung?) Gibt es Besonderheiten oder verwertbare Gegenstände?"
            {...register("message")}
        ...
        <div className="pt-4 flex flex-row gap-4">
          ...
          <CustomButton 
            primaryText={isSubmitting ? "Sende..." : "Besichtigung anfragen"}
